...
export class NewsComponent extends Component {
  ...
  async componentDidMount(){
      let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}${this.props.category}${this.props.category}${this.props.category}${this.props.category}${this.props.category}${this.props.category}${this.props.category}${this.props.category}business&apiKey=cbb13c851680451382ecaafefbba9a54&page=1&pageSize=${this.props.pageSize}`
